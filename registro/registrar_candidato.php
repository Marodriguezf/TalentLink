...
<body>
    ...
    <form class="formulario" method="post">
        <div class="crear col-md-8 col-lg-4 border rounded mx-auto mt-5 p-4 shadow">
            <div class="h2" style="color: #080F56;">Registrar Candidato</div>
            ...
            <div class="input-group mt-3">
                ...
                <input name="date" type="date" class="form-control" placeholder="Fecha de Nacimiento">
            </div>
            <div><small class="js-error js-error-password text-danger"></small></div>
            <div class="input-group mt-3">
                <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-user"></i></span>
                <input name="documento" type="number" class="form-control" placeholder="Numero de documento">
            </div>
            <div class="input-group mt-3">
                <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-user"></i></span>
                <input type="file" class="form-control" placeholder="Hoja de vida">
            </div>


       
            <button class="mt-3 btn btn-primary col-12"
                style="background-color: #ff7300; border-color: #ff7300;">Registrar Candidato</button>
