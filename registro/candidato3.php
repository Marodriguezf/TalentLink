...
<body>
    ...
    <div class="detail">
        ...
        <div class="detail-desc">
            <div class="about">
                <h4>Perfil</h4>
                <p>Tecnologa en finanzas con 4 años de experiencia trabajando con multinacionales</p </div>
                <div class="requisitos">
                    <h4>Experiencia</h4>
                    <ul>
                        <strong>
                            <li>BDO Outsourcing</li>
                        </strong>
                        <p>jul 2018 - jul 2022</p>
                        <p>4 años</p>
                        <p>Analizar la situación financiera de la empresa.
                            Recopilar datos, estudiarlos y trazar planes financieros de inversión para tu empresa o
                            cliente.
                            .</p>
                    </ul>
                </div>
