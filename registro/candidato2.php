...
<body>
    ...
    <div class="detail">
        ...
        <div class="detail-desc">
            <div class="about">
                <h4>Perfil</h4>
                <p>Tecnico en contaduria con experiencia en procesos de facturación y nómina.</p </div>
                <div class="requisitos">
                    ...
                    <ul>
                        ...
                        <p>Ene 2010 - sept 2023</p>
                        <p>3 años </p>
                        <p>Gestionar los informes de nóminas.</p>
                    </ul>
                </div>
                <div class="funciones">
