    ...
    <div class="detail">
        ...
        <div class="detail-desc">
            ...
            <div class="requisitos">
                <h4>Requisitos</h4>
                <ul>
                    <li>Tecnico, tecnologo en sistemas o afines</li>
                    <li>Mantenimient de 2 años en Configuración y soporte de Firewall</li>
                    <li>conocimiento en gestión de tickets</li>
                </ul>
            </div>
            <div class="funciones">
                <h4>Funciones</h4>
